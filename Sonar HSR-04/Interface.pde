...
size (1355, 725); //Resolução da sua tela
smooth();
 
 
Porta_serial = new Serial(this,"COM11", 9600);   // Começa a comunicação Serie
...
fill(98,245,31);        //Cor (no caso é verde)
textFont(orcFont);
